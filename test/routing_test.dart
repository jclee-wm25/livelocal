...
void main() {
  group('NearestNeighborRouting', () {
    ...
    test('Test multiple locations sorts correctly based on proximity', () {
      ...
      final route = routingStrategy.calculateRoute(0.0, 0.0, [spot1, spot2], [rest1]);
    ...
    test('Test identical coordinates handles gracefully', () {
      ...
      final route = routingStrategy.calculateRoute(1.0, 1.0, [spot1, spot2], []);
    ...
    test('Test missing coordinates are ignored (fallback behavior)', () {
      ...
      final route = routingStrategy.calculateRoute(0.0, 0.0, [spot1, spot2], []);
