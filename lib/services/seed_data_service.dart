...
class SeedDataService {
  ...
  static List<SpotModel> getInitialSpots() => [
    SpotModel(
      ...
      category: 'Kopitiam',
      description: 'Authentic 70-year-old Hainanese kopitiam known only to locals in George Town. Famous for traditional charcoal-grilled kaya toast and thick kopi O.',
      state: 'Penang',
      city: 'George Town',
    ...
    SpotModel(
      ...
      description: 'Vibrant local night market frequented by neighborhood residents for authentic Apam Balik, Ramly burgers, and fresh local fruit juices.',
      state: 'Kuala Lumpur',
    ...
    SpotModel(
      ...
      category: 'Indie Cafe',
      description: 'Tucked away in a quiet alley, this heritage cafe brews authentic Ipoh White Coffee using traditional wood-roasted coffee beans.',
      state: 'Perak',
      city: 'Ipoh',
    ...
    SpotModel(
      ...
      description: 'Historical street filled with local bakeries, independent coffee roastaries, and traditional laundry shops preserved since the 1930s.',
      state: 'Johor',
      city: 'Johor Bahru',
  ...
  static List<ReviewModel> getInitialReviews() => [
    ReviewModel(
      ...
      userName: 'Alex Tan',
      rating: 5.0,
      comment: 'Super authentic Hainanese coffee! The toast was perfectly crispy and charcoal grilled. A true hidden gem.',
