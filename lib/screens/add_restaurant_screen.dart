...
class _AddRestaurantScreenState extends State<AddRestaurantScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Influencer Food Review',
            style: TextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'City / Area *', border: OutlineInputBorder()),
                validator: (val) =>
                    val == null || val.isEmpty ? 'Required' : null,
              ),
              const SizedBox(height: 16),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText:
                        'Reviewed Dishes (e.g. Char Kuey Teow, Duck Egg) *',
                    border: OutlineInputBorder()),
                validator: (val) =>
                    val == null || val.isEmpty ? 'Required' : null,
              ),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'TikTok / Instagram Review Post Link *',
                    border: OutlineInputBorder()),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'Restaurant Cover Photo URL *',
                    border: OutlineInputBorder()),
                validator: (val) =>
                    val == null || val.isEmpty ? 'Photo URL required' : null,
              ),
              const SizedBox(height: 24),
              const Text('Add Exclusive Discount Code (Optional)',
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              const SizedBox(height: 10),
              TextFormField(
                controller: _discountCodeCtrl,
                decoration: const InputDecoration(
                    labelText: 'Discount Code (e.g. FOODIE10)',
                    border: OutlineInputBorder()),
              ),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'Discount Description (e.g. 10% OFF all items)',
                    border: OutlineInputBorder()),
              ),
              const SizedBox(height: 24),
              ElevatedButton(
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (context.mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text('Food review & discount published!'),
                            backgroundColor: AppColors.primary),
                      );
                ...
                child: const Text('Publish Review Listing',
